    ...
    return (
        <header className='bg-white'>
                ...
                <div className="header-content">
                    <div className="header-left">
                        ...
                        <ul className='dekstop-nav list-unstyled m-0'>
                            ...
                            <li><button className='clean-button' onClick={() => { changeCategory("Cake") }}>Cake</button></li>
                            <li><button className='clean-button' onClick={() => { changeCategory("Chocklate") }}>Chocklate</button></li>
                            <li><button className='clean-button' onClick={() => { changeCategory("Ice cream") }}>Ice cream</button></li>
            ...
            <ul className={nav ? 'mobile-nav open-nav  list-unstyled m-0' : 'mobile-nav list-unstyled m-0'}>
                ...
                <li><button className='clean-button' onClick={() => { changeCategory("Cake"); closeHamburger() }}>Cake</button></li>
                <li><button className='clean-button' onClick={() => { changeCategory("Chocklate"); closeHamburger() }}>Chocklate</button></li>
                <li><button className='clean-button' onClick={() => { changeCategory("Ice cream"); closeHamburger() }}>Ice cream</button></li>
                <li><Link to="/FeedbackForm"><button className='clean-button'>FeedbackForm</button></Link></li>
